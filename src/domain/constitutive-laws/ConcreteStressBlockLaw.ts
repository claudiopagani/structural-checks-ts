...
export interface ConcreteStressBlockLawOptions {
  fcd: number;
  eta?: number;
  ec4?: number;
  ecu: number;
...
export class ConcreteStressBlockLaw implements ConcreteUltimateConstitutiveLaw {
  fcd: number;
  eta: number;
  ec4: number;
  ecu: number;
