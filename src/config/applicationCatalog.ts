export type ApplicationMaturity =
  | "implemented-local"
  | "partial"
  | "scaffolded"
  | "implemented"
...
export interface ApplicationCatalogEntry {
  ...
  readonly maturity: ApplicationMaturity;
  readonly primaryFocus: string;
}

export const APPLICATION_CATALOG: ApplicationCatalogEntry[] = [
  {
  ...
  {
    id: "rc-building-verification",
    name: "RC Building Verification",
    domain: "reinforced-concrete",
    maturity: "partial",
    primaryFocus:
      "Global NTC 2018 building verification from FEM results: regularity, capacity design, storey drift, P-Delta.",
  },
  {
    id: "timber-beams",
    name: "Timber Beams",
