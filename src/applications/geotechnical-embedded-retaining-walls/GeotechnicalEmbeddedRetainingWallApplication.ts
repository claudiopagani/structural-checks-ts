...
} from "../../domain/geotechnics/EmbeddedRetainingWallAnalysis.js";

export class GeotechnicalEmbeddedRetainingWallApplication extends StructuralApplication {
  constructor() {
    super({
  ...
  override run(input: EmbeddedRetainingWallAnalysisInput = {}): CalculationResult {
