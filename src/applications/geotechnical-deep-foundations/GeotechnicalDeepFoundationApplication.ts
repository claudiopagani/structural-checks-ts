...
import {
  ...
  type AxialPileCapacityAnalysisInput,
} from "../../norms/geotechnics/AxialPileCapacityAnalysis.js";

export class GeotechnicalDeepFoundationApplication extends StructuralApplication {
  constructor() {
    super({
  ...
  override run(input: AxialPileCapacityAnalysisInput = {}): CalculationResult {
    ...
    return new CalculationResult({
      ...
      metadata: { domain: this.domain, ...analysis.metadata },
    });
  }
}
