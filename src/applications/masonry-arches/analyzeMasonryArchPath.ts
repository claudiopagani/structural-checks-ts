...
function analyzeMasonryArchPathCore(
  ...
  return new CalculationResult<MasonryArchPathOutputs>({
    ...
    assumptions: [
      ...
      "Bonded layers in deformable/path analyses are assessed as static-admissibility capacity contributions on the converged resultant field; they do not contribute constitutive stiffness or force to the deformable equilibrium residual, and their reported state is the minimum-required static-admissibility recovery against the masonry limit domain, never a strain-compatibility force.",
