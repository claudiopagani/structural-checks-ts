...
export interface MasonryOutOfPlaneApplicationInput {
  code?: string;
...
export class MasonryOutOfPlaneApplication extends StructuralApplication {
  constructor() {
    super({
      ...
      description: "Local kinematic analysis of masonry walls for out-of-plane mechanisms.",
      domain: "masonry",
  ...
  override run(
    input: MasonryOutOfPlaneApplicationInput = {},
