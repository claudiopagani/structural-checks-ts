// Mechanical TypeScript migration from strutture-js 6f33baead8b88166c4b2cf94af41763412e3c751; source path: src/applications/index.js.
...
import { RcBuildingVerificationApplication } from "./rc-building-verification/index.js";
...
} from "./rc-building-verification/index.js";
export {
...
export function createDefaultApplicationRegistry() {
  // The pinned JavaScript registry intentionally accepts heterogeneous application inputs and results.
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  return new ApplicationRegistry<any, any, any>([
    ...
    new RcBuildingVerificationApplication(),
