...
} from "../../domain/geotechnics/GroundAnchorAnalysis.js";

export class GeotechnicalGroundAnchorApplication extends StructuralApplication {
  constructor() {
    super({
  ...
  override run(input: GroundAnchorAnalysisOptions = {}): CalculationResult {
