...
export interface MasonryRingBeamApplicationModel {
  id?: string | null;
  opening?: { id?: string | null } | null;
}

export interface MasonryRingBeamApplicationInput {
  code?: string | null;
  model?: MasonryRingBeamApplicationModel | null;
}
...
export class MasonryRingBeamApplication extends StructuralApplication {
  ...
  override run(
    input: MasonryRingBeamApplicationInput = {},
  ): ReturnType<StructuralApplication["createPlaceholderResult"]> {
