...
import type { MomentCurvaturePoint } from "../analysis/moment-curvature/types.js";
...
function summarizeOptionalPoint(
  point: MomentCurvaturePoint | null,
): Record<string, unknown> | null {
  return point == null ? null : RCMomentCurvatureAnalyzer.summarizePoint(point);
}

export function runMomentCurvatureWorkflow(
  ...
  return new VerificationResult({
    ...
    status:
      summarizedPoints.length > 1 && allConverged ? RESULT_STATUS.OK : RESULT_STATUS.NOT_VERIFIED,
    summary:
    ...
    outputs: {
      ...
      maxPostUltimateCurvatureRatio: round(curve.maxPostUltimateCurvatureRatio, 6),
      postUltimateCurvatureLimit: round(curve.postUltimateCurvatureLimit, 12),
      ...
      postUltimateCurvatureLimitReached: curve.postUltimateCurvatureLimitReached,
      ...
      materialUltimatePoint: summarizeOptionalPoint(curve.materialUltimatePoint),
      balancedFailurePoint: summarizeOptionalPoint(curve.balancedFailurePoint),
      balancedCurvaturePoint: summarizeOptionalPoint(curve.balancedCurvaturePoint),
      ...
      postUltimateTerminationPoint: summarizeOptionalPoint(curve.postUltimateTerminationPoint),
      ntc2018Ductility: RCMomentCurvatureAnalyzer.summarizeDuctility(curve.ntc2018Ductility),
    ...
    metadata: withNormativeReferences(
      ...
      [
        ...
        NTC2018_RC_CHAPTER_4_REFERENCES.curvatureDuctility,
      ],
    ),
  });
}
