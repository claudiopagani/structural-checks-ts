...
} from "../../domain/geotechnics/CircularSlopeStabilityAnalysis.js";

export type GeotechnicalSlopeStabilityApplicationInput = CircularSlopeStabilityAnalysisInput;
...
export class GeotechnicalSlopeStabilityApplication extends StructuralApplication {
  ...
  override run(input: GeotechnicalSlopeStabilityApplicationInput = {}): CalculationResult {
