...
const sourcePath = "validation/reinforced-concrete-plate-sources.md";
const sourceBlobSha1 = "7d2e690e64a14632a755379e66d933f0de07fb84";

function gitOutput(repository: string, ...arguments_: readonly string[]): string {
  return execFileSync("git", ["-C", repository, ...arguments_], { encoding: "utf8" }).trim();
}

void test("reinforced-concrete plate validation sources match the pinned source exactly", () => {
