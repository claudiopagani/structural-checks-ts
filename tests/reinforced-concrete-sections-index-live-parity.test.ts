...
void test("reinforced concrete sections index matches the independent pinned JavaScript implementation", async () => {
  ...
  const sourceModule = await loadModule(
    sourceRoot,
    "src/applications/reinforced-concrete-sections/index.js",
  );
  const typescriptModule = await loadModule(
    path.join(repositoryRoot, "dist"),
    "applications/reinforced-concrete-sections/index.js",
  );
