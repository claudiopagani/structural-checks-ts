...
| --------------------------------- | ----------------: | -----------------: |
| Root exports                      |               841 |                536 |
| Applications exports              |               309 |                172 |
| Package entry points              |                14 |                  2 |
| ApplicationRegistry entries       |                30 |                  0 |
| Application catalog entries       |                30 |                 30 |
| Serialized schema/version symbols |                49 |                 34 |
| Source files                      |               480 |                326 |
| Tests                             |               131 |                170 |
...
- **domain** — partial: 20, missing: 80.
- **norms** — partial: 16, missing: 157.
- **applications** — partial: 16, missing: 367.
